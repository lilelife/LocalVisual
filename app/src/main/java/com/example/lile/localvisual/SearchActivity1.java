...
public class SearchActivity1 extends Activity {
    ...
    private void init(){
        ...
        helper = new RecordSQLiteOpenHelper(getApplicationContext());
        // 第一次进入时查询所有的历史记录
        queryData("");
        //"清空搜索历史"按钮
        ...
        btn_deletetd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                et_search.setText("");
            }
...
//                }
    ...
    private void queryData(String tempName) {
        ...
        adapter = new SimpleCursorAdapter(getApplicationContext(), android.R.layout.simple_list_item_1, cursor, new String[] { "name" },
